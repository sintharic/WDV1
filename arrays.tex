...
\lstinputlisting[language=Python, label=lst:SOSana, caption=Sehr traditionelle Lösung der oben gestellten Aufgabe.]{ArraysCode/SOSana.py}
...
\lstinputlisting[language=Python, label=lst:SOSfor, caption=Traditionelle Lösung der gestellten Aufgabe mit der Variablen \texttt{summe}.]{ArraysCode/SOSfor.py}
...
\lstinputlisting[language=Python, label=lst:SOSwhile, caption=Demonstration einer \texttt{while} Schleife.]{ArraysCode/SOSwhile.py}
